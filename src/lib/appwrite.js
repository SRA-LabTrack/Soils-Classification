...
export const APPWRITE = {
  ...
  tables: {
    ...
    changes: import.meta.env.VITE_APPWRITE_SPATIAL_CHANGES_TABLE_ID || 'spatial_changes',
    support: import.meta.env.VITE_APPWRITE_SUPPORT_MESSAGES_TABLE_ID || 'support_messages',
    requests: import.meta.env.VITE_APPWRITE_SPATIAL_REQUESTS_TABLE_ID || 'spatial_requests',
  },
};
